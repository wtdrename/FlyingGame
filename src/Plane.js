...
export class Plane {
    ...
    _createMesh() {
        ...
        // CORREÇÃO: minúsculas em .position.z
        nose.position.Z = 3; 
        this.mesh.add(nose);
    ...
    update(keys) {
        ...
        // CORREÇÃO: minúsculas em .position.y e .rotation
        if (keys['ArrowUp']) {
            targetPitch = -0.5; 
        ...
        // CORREÇÃO: .rotation.x e .rotation.z (minúsculos)
        this.mesh.rotation.X = this.pitch;
        this.mesh.rotation.Z = this.roll;

        // 3. MOVIMENTO FRONTAL
        // Se o nariz aponta para Z+, translateZ move para a frente.
